...
public class ArithmeticCalculatorServlet extends HttpServlet {
    ...
    request.setAttribute("message",message);
        this.getServletContext ().getRequestDispatcher("/WEB-INF/arithemticcalculator.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String firstStr;
        firstStr = request.getParameter("first");
        String secondStr;
        secondStr = request.getParameter("second");
        String operation;
